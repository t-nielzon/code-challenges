 ...
 * based, so the zeroth index is even, therefore that character should be upper
 * cased.
 *
 * Indexing resets for each word. In other words, the first letter of every word
 * is index 0 (even), so it must always be uppercase, etc.
 *
