 ...
 * in each word lower cased. The indexing is zero based, so the zeroth index is even, 
 * therefore that character should be upper cased. Indexing resets for each word.
 * 
