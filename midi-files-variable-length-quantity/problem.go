...
Removing the continuation bit leaves: 1111111 = 127

Values larger than 127 require multiple bytes.
For example: [0x81, 0x00] in binary becomes 10000001 00000000
Removing the continuation bits gives: 0000001 0000000 = 128

# Task

Implement two functions:
- encode(n): convert an integer into a MIDI VLQ byte sequence
- decode(data): decode only the first complete MIDI VLQ contained in the input
