...
when you consider only the divisors other than n itself. In the following description, divisors will
...
first pair (n m) of buddy pairs such that n is between start (inclusive) and limit (inclusive);
