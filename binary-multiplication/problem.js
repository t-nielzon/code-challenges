/*
 * Binary multiplication using the ancient Egyptian method.
 * 
 * The goal is to multiply two integers using the ancient Egyptian method,
 * which only requires divisions and multiplications by two, and additions.
 * 
 * Your function takes two integers as input. It shall return a list of the steps
 ...
 * The result of the multiplication is the sum of the list elements, but you have
 * to return only the list.
 * 
