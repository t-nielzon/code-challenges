...
- ls (list of distances, all distances are positive or zero integers)

The function returns the biggest possible sum of k distances less than or equal to the given limit t, if that sum exists,
or otherwise -1.

Examples:
chooseBestSum(163, 3, [50, 55, 56, 57, 58]) -> 163
chooseBestSum(163, 3, [50]) -> -1
