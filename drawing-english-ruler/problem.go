...
A standard English ruler is marked in inches. For each whole inch, the ruler shows a major tick
with a numeric label. Each time the interval size is halved, the tick length decreases by 1.
