...
//
// The two subarrays are sorted in ascending order by their number weights if these
// weights are different, by their indexes in the string if they have the same weights.
//
// In Go the result is returned as a string.
//
// #### Examples:
