 ...
 * a control string would be `aaabbbbhaijjjm` meaning that the printer used three
 ...
 * control string is produced e.g. `uuaaaxbbbbyyhwawiwjjjwwxym` where errors are
 * reported with letters `u`, `w`, `x` or `z`.
 *
 ...
 * characters, a white space, number of error for that letter in a field of 6,
 * as many "*" as the number of errors for that letter and "\r".
 *
