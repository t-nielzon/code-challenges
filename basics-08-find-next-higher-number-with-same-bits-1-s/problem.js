 ...
 *
 * Your task is to find the next higher number (int) with the same number
 * of bits set in its binary representation, i.e. as many 1 bits as before,
 * but next higher than input.
 *
