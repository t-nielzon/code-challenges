...
Given a number sum_limit, you should give the first sextuplet which sum (of its six primes)
surpasses the sum_limit value.

Examples:
- FindPrimesSextuplet(70) == [7, 11, 13, 17, 19, 23]
- FindPrimesSextuplet(600) == [97, 101, 103, 107, 109, 113]
