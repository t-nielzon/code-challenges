...
Examples:
    LastDigit(big.NewInt(4), big.NewInt(1))  // returns 4
    LastDigit(big.NewInt(4), big.NewInt(2))  // returns 6
    LastDigit(big.NewInt(9), big.NewInt(7))  // returns 9
    LastDigit(big.NewInt(10), big.NewInt(10000000000)) // returns 0
*/
