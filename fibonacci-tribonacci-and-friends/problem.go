...
that mister Fibonacci has at least a bigger brother. If not, give it a
...
sum of the 4 previous, a Pentabonacci with a signature of 5 elements and
...
- and remember each next element is the sum of the last X elements - and
