...
Example scoring:
Throw [5, 1, 3, 4, 1] => 250: 50 (for the 5) + 2 * 100 (for the 1s)
Throw [1, 1, 1, 3, 1] => 1100: 1000 (for three 1s) + 100 (for the other 1)
Throw [2, 4, 4, 5, 4] => 450: 400 (for three 4s) + 50 (for the 5)
*/
