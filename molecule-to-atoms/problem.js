 ...
 *
 * Some formulas have brackets in them. The index outside the brackets tells
 * you that you have to multiply count of each atom inside the bracket by this
 * index. For example, in Fe(NO3)2 you have one iron atom, two nitrogen atoms
