...
Write a function KprimesStep(k, step, start, nd) with parameters:
...
This function should return an array of all the pairs of k-prime numbers spaced with
a step of step between the limits start, nd. This array can be empty.
