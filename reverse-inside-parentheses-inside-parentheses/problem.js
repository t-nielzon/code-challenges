 ...
 * then that too must be reversed back, so it faces the original direction. When parentheses
 * are reversed, they should switch directions, so they remain syntactically correct
 ...
 *
 * Input parentheses will always be valid. Strings without any parentheses are possible and
