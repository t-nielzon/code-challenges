...
Given the lines of his phone book and a phone number num, return a string for this number:
"Phone => num, Name => name, Address => adress"

If there are many people for a phone number num, return:
"Error => Too many people: num"

If the number num is not in the phone book, return:
"Error => Not found: num"
*/
package kata
