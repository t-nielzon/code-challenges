...
// and returns an array of the k-primes between start (inclusive) and end
// (inclusive). A nil slice is expected when there are no k-primes in range.
//
// Example:
...
//   puzzle(143)  -->  2   because [3 + 12 + 128] and [7 + 8 + 128]
