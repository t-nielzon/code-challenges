 ...
 * character at a 0-based index. Return the RLE of the string: each consecutive
 * sequence of the same character is represented as <count><char>.
 *
 * Blocks such as "0w", "00a", or any block starting with a zero are not valid
 * RLE and must not appear in the output.
 * All characters in the virtual string will be non-digit characters, so no
 * output block will ever contain a digit as the character itself.
