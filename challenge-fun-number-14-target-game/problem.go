...
(one at a time) and it takes you a full second to reload your water-gun
after shooting (you start the game already loaded).
...
Input: integer array vals - point values of targets in order of appearance.
Output: an integer - the maximum number of points you can score.
*/
package kata
